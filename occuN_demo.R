...
#     png_filename <- paste0("comparison_plot_ref=", ref_scenario_name, ".png")
...
# write.csv(descriptive_stats_df, "descriptive_stats.csv", row.names = FALSE)
# write.csv(performance_metrics_df, "performance_metrics.csv", row.names = FALSE)
...
for (ref_scenario_name in reference_scenarios) {
    ...
    # --- UPDATED: Save PNG to output folder ---
...
# --- UPDATED: Save CSVs to output folder ---
